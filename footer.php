...
?>
	...
	<footer id="colophon" class="site-footer">
		<div id="connect" class="container">
			<div class="row">
				<div class="col-sm-12 col-md-12 col-lg-6 col-lg-offset-3">
					...
					<p>Follow us on social media to get more of an insight into our philosophy and vision for Arteries. Let's connect and share ideas to create better communities for the future.</p>
					<p>
		...
		<div id="insta" class="container">
			<div class="row">
				<div id="insta1" class="insta-pic col-sm-12 col-md-3 col-lg-3">
				</div>
				<div id="insta2" class="insta-pic col-sm-12 col-md-3 col-lg-3">
				</div>
				<div id="insta3" class="insta-pic col-sm-12 col-md-3 col-lg-3">
				</div>
				<div id="insta4" class="insta-pic col-sm-12 col-md-3 col-lg-3">
				</div>
			</div>
		</div>
