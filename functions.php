...
// Set UI labels for Custom Post Type
    $labels = array(
        'name'                => _x( 'Connections', 'Post Type General Name', 'arteries' ),
        'singular_name'       => _x( 'Connection', 'Post Type Singular Name', 'arteries' ),
        'menu_name'           => __( 'Connections', 'arteries' ),
        'parent_item_colon'   => __( 'Parent Connection', 'arteries' ),
        'all_items'           => __( 'All Connections', 'arteries' ),
        'view_item'           => __( 'View Connection', 'arteries' ),
        'add_new_item'        => __( 'Add New Connection', 'arteries' ),
        'add_new'             => __( 'Add New', 'arteries' ),
        'edit_item'           => __( 'Edit Connection', 'arteries' ),
        'update_item'         => __( 'Update Connection', 'arteries' ),
        'search_items'        => __( 'Search Connection', 'arteries' ),
        'not_found'           => __( 'Not Found', 'arteries' ),
        'not_found_in_trash'  => __( 'Not found in Trash', 'arteries' ),
    );
     
// Set other options for Custom Post Type
     
    $args = array(
        'label'               => __( 'connections', 'arteries' ),
        'description'         => __( 'Connections on about us page', 'arteries' ),
        'labels'              => $labels,
