	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
			<div id="contact-background" class="container">
				<div class="darken">
					<div class="row">
						<div id="contact-intro" class="col-xs-12 col-sm-4 col-sm-offset-4 col-md-4 col-md-offset-4 col-lg-4 col-lg-offset-4">
				...
				<div class="row">
					<div id="info" class="col-sm-12 col-md-12 col-lg-6 col-lg-offset-3">
						...
						<div class="submit">
							...
							<svg id="form_svg" width="20" height="12" xmlns="http://www.w3.org/2000/svg" xmlns:svg="http://www.w3.org/2000/svg">
